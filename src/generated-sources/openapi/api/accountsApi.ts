...
export class AccountsApi {
     ...
     */
    public async accountsGet (pageSize?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ListAccountsResponse;  }> {
     ...
     */
    public async accountsIdGet (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetAccountResponse;  }> {
